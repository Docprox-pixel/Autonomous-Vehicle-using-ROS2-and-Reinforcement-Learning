...
: ${AMENT_CURRENT_PREFIX:="/home/doc/auto_ws/src/auto_car/install/auto_car"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/auto_car/environment/pythonpath.sh"
